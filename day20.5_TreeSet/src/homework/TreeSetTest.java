...
public class TreeSetTest {
	...
	public void Test1() {
		...
		for (int i = 0; i < 5; i++) {
			...
			age = localDateTime.getYear() - year;
		...
		Comparator comparator = new Comparator() {
			// 泛型写法： Comparator<Employee> comparator = new Comparator<Employee>() {
		...
		// 泛型写法： TreeSet<Employee> set = new TreeSet<>(comparator);
		...
		// 泛型写法： Iterator<Employee> iterator = set.iterator();
