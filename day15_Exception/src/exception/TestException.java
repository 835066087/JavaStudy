...
public class TestException {
	...
	public static void main(String[] args) {
		...
		/*
		 * Scanner scan = new Scanner(System.in); System.out.println("请输入第一个数字"); int n1
		 * = scan.nextInt(); System.out.println("请输入第二个数字"); int n2 = scan.nextInt();
		 */
		...
		} catch (ArrayIndexOutOfBoundsException ex) {// 真的异常抛出，用EX抛出，并捕获之
			ex.printStackTrace();// 打印异常对象的栈踪迹
		} catch (NumberFormatException ex) {
			System.out.println(ex.getMessage());// 获取异常对象的详细信息
		} catch (Exception ex) {//万能夹保底
